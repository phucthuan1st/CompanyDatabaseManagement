...
BEGIN
    ...
    SELECT NV.VAITRO INTO ROL FROM COMPANY_PUBLIC.NHANVIEN_VAITRO NV WHERE MANV= USR;
...
BEGIN
    ...
    --update trên LUONG nếu LUONG = NULL
 
     DBMS_RLS.ADD_POLICY(
        OBJECT_SCHEMA => 'COMPANY_PUBLIC',
        OBJECT_NAME => 'NHANVIEN',
        POLICY_NAME => 'NHANSU_UPDATE_LUONG_PC',
     ...
     --update trên PHUCAP nếu PHUCAP = NULL   
     DBMS_RLS.ADD_POLICY(
        OBJECT_SCHEMA => 'COMPANY_PUBLIC',
        OBJECT_NAME => 'NHANVIEN',
        POLICY_NAME => 'NHANSU_UPDATE_PHUCAP_PC',
        POLICY_FUNCTION => 'a_CS_NHANSU_3',
        STATEMENT_TYPES => 'UPDATE, INSERT',
